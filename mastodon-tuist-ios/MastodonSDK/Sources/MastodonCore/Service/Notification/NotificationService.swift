...
public final class NotificationService {
    ...
    public static let unreadShortcutItemIdentifier = "dev.tuist.mastodon.NotificationService.unread-shortcut"

    private var disposeBag = Set<AnyCancellable>()

    private let workingQueue = DispatchQueue(label: "dev.tuist.mastodon.NotificationService.working-queue")
